...
\citep{centrality2021highlight,sheikamamuddy2021allosteric,
...
semantic levels; PNMAVis \citep{guo2022pnmavis} couples normal mode
analysis (NMA) with pocket dynamics to provide mode-based
interpretations of pocket variation; VAPPD \citep{guo2022vappd} proposes
...
analytical system; and the more recent PocketSCP \citep{guo2025pocketscp}
...
level, D3Pockets \citep{xu2019d3pockets} provides a systematic web service
for pocket dynamics, while works such as
\textit{Visual Analysis of Large-Scale Protein--Ligand Interaction
Data} \citep{schatz2021visual} contribute complementary
...
\citep{zhan2020spatiotemporal,guo2022vappd,guo2025pocketscp};
and the other focusing on \emph{network-driven residue analysis}
\citep{vishveshwara2009modeling,centrality2021highlight,
